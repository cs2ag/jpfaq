...
/**
 * Testcase for class Tx_Jpfaq_Domain_Model_Category.
 *
 * @version $Id$
 ...
 */
class Tx_Jpfaq_Domain_Model_CategoryTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Jpfaq_Domain_Model_Category
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Jpfaq_Domain_Model_Category();
	}
