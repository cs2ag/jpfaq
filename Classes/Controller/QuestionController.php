...
class Tx_Jpfaq_Controller_QuestionController extends Tx_Extbase_MVC_Controller_ActionController
{
    ...
    public function listAction()
    {
        ...
        jQuery(document).ready(function($){
            ...
            $('.jpfaqShow$selectedCategory').click(function(){
                $('.toggleTriggerContainer$selectedCategory').removeClass("active");
                $('.toggleTriggerContainer$selectedCategory').addClass("active").slideDown('fast');
                $('ul.listCategory$selectedCategory .toggleTrigger').removeClass("questionUnfolded");
                $('ul.listCategory$selectedCategory .toggleTrigger').addClass("questionUnfolded");
                $('.jpfaqShow$selectedCategory').hide();
                $('.jpfaqHide$selectedCategory').show();
            });
            $('.jpfaqHide$selectedCategory').click(function(){
                $('.toggleTriggerContainer$selectedCategory').removeClass("active").slideUp('fast');
                $('ul.listCategory$selectedCategory .toggleTrigger').removeClass("questionUnfolded");
                $('.jpfaqHide$selectedCategory').hide();
                $('.jpfaqShow$selectedCategory').show();
            });
        });
HEREDOC;
